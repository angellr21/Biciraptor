jQuery(function ($) {
  ...
  $(".animated-all .animated:not(.animation-done)").waypoint(
    function () {
  ...
  $(".isotope-filter").isotope({ itemSelector: ".isotope-item" });
  ...
  jQuery(".minus_btn").click(function () {
    ...
    var qty = parseInt(inputEl.val(), 10) || 0;
  ...
  $("#slider-product .slides > li a").magnificPopup({ type: "image" });
  $(".video-popab").prettyPhoto({ theme: "dark_square" });
  ...
  if ($flcr_feed.length) {
    $("#flickr-feed").jflickrfeed({
      limit: 9,
      qstrings: { id: "120066133@N02" },
      itemTemplate:
        '<li><a href="{{image_b}}" rel="prettyPhoto[flickr]"><img src="{{image_s}}" alt="{{title}}" /><span><i class="icomoon-search"></i></span></a></li>',
      ...
      function Starrr($el, options) {
        ...
        this.$el.on("mouseover.starrr", "i", function (e) {
          return _this.syncRating(
            _this.$el.find("i").index(e.currentTarget) + 1,
          );
        });
